...
/* connection */
   ...
   $username = "root";
    ...
    /*
      ...
      $sql="create table Foot (Name varchar (20), CIN int, Sector varchar (6),Date date, Time time);";
      $conn->query($sql);
    ...
    $sql = "select Date,date_format(Time,'%H:%i')  from Foot";
  ...
  if($def==0){  //if le temps selectioné n'est pas reservé avant 
          ...
          //insert into table 
      $sql="insert into Foot (Name,CIN,Sector,Date,Time) value ('$Name','$Cin','$Sector','$Date','$Time');";
